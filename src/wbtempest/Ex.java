...
public class Ex {
    ...
    protected static Random rnd = new Random(new java.util.Date().getTime());
    
    // possible states of an ex
	protected static enum State {STRAIGHT, JUMPRIGHT1, JUMPLEFT1, JUMPRIGHT2, JUMPLEFT2, LANDRIGHT1, LANDRIGHT2, LANDLEFT1, LANDLEFT2};
    ...
    protected int col;
    protected int ncols;
    protected double z = Board.LEVEL_DEPTH;
    protected boolean visible;
    protected int jumptimer = 0;
    protected State prefdir = State.JUMPRIGHT1;  // initial predisp to jump right
    protected State s = prefdir;
    protected boolean canMove=false;
    protected boolean levContinuous;
